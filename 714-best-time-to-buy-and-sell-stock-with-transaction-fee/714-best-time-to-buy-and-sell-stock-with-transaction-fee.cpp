...
public:
    int maxProfit(vector<int>& prices, int fee) {
        ...
        int max_profit_when_already_bought[n];
        int max_profit_when_already_sold[n];
        
        max_profit_when_already_bought[0] = -prices[0];
        ...
        for(int i=1;i<n;i++){
            ...
            */
            max_profit_when_already_bought[i] = max(
                                                    max_profit_when_already_bought[i-1],
            ...
            */
            max_profit_when_already_sold[i] = max(
                                                    ...
                                                    max_profit_when_already_bought[i-1]+prices[i]-fee
                                                );
        }
